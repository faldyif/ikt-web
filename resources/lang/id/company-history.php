...
return [
    ...
    <div class="col-md-4">
    <img class="img-responsive" src="'.url("img/1_history.jpg").'"><br>
    </div>
    <div class="col-md-8">
    <blockquote class="blockquote">
    <h4>Horizontal Car Parking</h4>
    <small><cite>Pembangunan Tanjung Priok Car Terminal</cite></small>
    </blockquote>
    </div>
    </div>
    ...
    <h4>Vertical Car Parking</h4>
    <small><cite>Pembangunan Tanjung Priok Car Terminal</cite></small>
    </blockquote>
    </div>
    <div class="col-md-4">
    <img class="img-responsive" src="'.url("img/2_history.jpg").'"><br>
    </div>
    </div>
    <p class="text-justify">
    ...
    <div class="col-md-12 flex-row-center">
    <div class="col-md-4">
    <img class="img-responsive" src="'.url("img/3_history.jpg").'"><br>
    </div>
    <div class="col-md-8">
    <blockquote class="blockquote">
    <h4>Gate</h4>
    ...
    <div class="col-md-4">
    <img class="img-responsive" src="'.url("img/4_history.jpg").'"><br>
    </div>
    </div>
    <p class="text-justify">
