...
@section('title', 'List Komentar Album')

@section('breadcrumb')
    <li><a href="{{ route('album.index') }}"><i class="fa fa-newspaper-o"></i> Album</a></li>
    <li><a href="{{ route('album-comment.index') }}"><i class="fa fa-newspaper-o"></i> List Komentar Album</a></li>
@endsection
    ...
    <script>
        ...
        function deleteConfirmation(id) {
            swal({
                ...
                text: 'Anda tidak akan dapat mengembalikan komentar album yang sudah dihapus!',
                type: 'warning',
                ...
                swal(
                    'Terhapus!',
                    'Komentar album yang anda pilih berhasil terhapus. Reload otomatis dalam 2 detik..',
                    'success'
                )
                setTimeout(function() {
                ...
                if (dismiss === 'cancel') {
                    swal(
                        'Dibatalkan',
                        'Komentar album yang anda pilih aman di database :)',
                        'error'
                    )
                }
            })
