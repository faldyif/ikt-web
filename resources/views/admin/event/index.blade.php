        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{ url('admin/event/create') }}" class="btn btn-block btn-primary">
                Buat Baru
              </a>
              </div>
            </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="{{ url('admin/event') }}/{{ $key->id }}/edit" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></a>
                      <a href="#" onclick="deleteConfirmation({{ $key->id }})" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                      {!! Form::open(['route' => ['event.destroy',$key->id], 'method' => 'delete', 'id' => 'delete_form_'.$key->id]) !!}
                      {!! Form::close() !!}
                    </div>
                  </td>
                </tr>
...
<script>
  ...
  function deleteConfirmation(id) {
    swal({
      ...
      text: 'Anda tidak akan dapat mengembalikan Agenda yang sudah dihapus!',
      type: 'warning',
      ...
      swal(
        'Terhapus!',
        'Agenda yang anda pilih berhasil terhapus. Reload otomatis dalam 2 detik..',
        'success'
      )
      setTimeout(function() {
      ...
      if (dismiss === 'cancel') {
        swal(
          'Dibatalkan',
          'Agenda yang anda pilih aman di database :)',
          'error'
        )
      }
    })
