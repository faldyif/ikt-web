    ...
    <section class="row pd-bt-30">
      <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
        <div class="col-md-5 col-sm-12">
         <img src="{{ url('img/pdf/1.jpg') }}" class="img-responsive">
       </div>
       <div class="col-md-7">
        <!-- <hr class="hrSpec hrSpecOrange"> -->
        <h3 style="font-size: 26px;" class="mg-b-30">Sinergi dalam Cinta</h3>
        <p style="font-size: 22px; font-family: helvetica;"><i>“Love is all you need....” </i></p>
        <p>Penggalan kalimat yang pernah dipopulerkan grup band legendaris asal  Liverpool, The Beatles ini terpampang di salah satu sudut dinding ruang IPC Car Terminal. Kalimat ini bukan sekadar pemanis ruangan. Akan tetapi, bisa dikatakan, ia merupakan ruh perusahaan ini.</p>
      </div>
      <div class="col-md-12"></div>
      <p class="text-justify" style="text-indent: 5em;">
        Hal yang mendasar yang kami lakukan adalah menterjemahkan visi IPC Car Terminal yang sudah ditetapkan, salah satu komponennya yaitu “mewujudkan Terminal Kendaraan berkelas dunia”, juga IPC Car Terminal Values, IPC Car Terminal Characters dan IPC Car Terminal Ways ke dalam perilaku kerja nyata sehari-hari.
        Saat ini, kami dalam membuat, mengembangkan dan membangun sesuatu. Fungsional saja kadang tidak cukup, fungsional dan estetika pun juga belum cukup. Perlu tambahan “soul” dan “message” pada fungsional dan estetika agar cahaya positif dan kebaikan itu memancar ke seluruh nusantara dan penjuru dunia.
        Terlebih yang kami bangun adalah Aset Negara, kami selalu sadar bahwa sesuatu yang kami bangun adalah milik negara sehingga harus woooouwwww dan tidak bisa diremehkan oleh perusahaan swasta. Apalagi dipandang sebelah mata oleh bangsa lain.
        Masa depan Bangsa Indonesia tidak bisa dibebankan di pundak seorang Presiden Jokowi, Wakil Presiden, Para Menteri dan BUMN-BUMN. Juga masa depan sebuah daerah tidak bisa dibebankan hanya dipundak seorang Kepala Daerah, Wakil Kepala Daerah, Kepala Dinas dan BUMD-BUMD nya. Namun masa depan Bangsa Indonesia juga ditentukan oleh kita semuanya sebagai Anak Bangsa berdasarkan peran, tanggung jawab dan masing-masing dari kita semuanya.
        Dengan peran yang diamanahkan kepada kami, kami bertekad akan membuat IPC Car Terminal berstandar internasional yang dapat sejajar dengan pelabuhan terbesar di Asia Tenggara dan Dunia. Inilah darma bakti kami kepada Ibu Pertiwi untuk membuat Bangsa Indonesia berdiri sama tinggi dan duduk sama rendah dengan bangsa-bangsa lainnya melalui :
      </p>
      <ol>  
        <li>1. Melanjutkan hal yang sudah baik </li>
        <li>2. Meluruskan yang belum lurus </li>
        <li>3. Menyelesaikan hal yang belum selesai </li>
        <li>4. Membuat dan membangun sesuatu yang baru </li>
      </ol>
      <p style="font-size: 22px; font-family: helvetica;"><i>Passion, Love & Culture</i></p>
      <p>Transformasi budaya perusahaan akan berhasil apabila manajemen fokus pada 5 hal utama, yaitu</p>
      <ol>
        <li> 
          <i>1. People</i>
          <p>Manajemen memberikan ruang inovasi, kreatiftas, kontribusi kepada seluruh karyawannya sesuai peran masing-masing. Selain itu manajemen berkewajiban menciptakan karyawan untuk fokus pada pelayanan pelanggan, integritas, juga bangga terhadap perusahaan beserta budayanya. <i> “ Every color gives a different meaning”</i></p>
        </li>
        <li> 
          <i>2. Budaya Perusahaan</i>
          <p>Budaya perusahaan akan memperkuat pembentukan karakter karyawan untuk menunjang marwah perusahaan. Budaya yang dibangun di IPC Car Terminal adalah CINTA : <i> Customer Centric, Integrity, Nationalism, Team work & Action.</i> Perusahaan yang berhasil adalah perusahaan yang menerapkan nilai-nilai perusahaan secara detail dan konsekuen dalam perilaku kerja semua karyawan</i></p>
        </li>

        <div class="col-sm-6">
          <img src="{{ url('img/pdf/3.jpg') }}" class="img-responsive">
        </div>

        <li> 
          <i>3. Good Corporate Governance</i>
          <p>Ada pepatah menyatakan <i> Trust takes years to build, second to break, and Forever
          to repair, </i> pepatah inilah yang menjadi landasan kami dalam menjaga marwah perusahaan dalam berhubungan dengan stakeholders. Meluruskan hal yang belum lurus</p>
        </li>
        <li> 
          <i>4. Pengembangan Usaha</i>
          <p>Untuk dikenal dunia salah satu indikatornya adalah IPC Car Terminal harus menangani volume yang banyak, maka harus ada pasar. Pasar akan datang apabila kita berkolaborasi dengan semua pihak, baik <i> regulator, shipping line, logistic company, cargo owner, stevedoring company. </i> Apabila pasar tumbuh maka akan butuh fasilitas dan peralatan perusahaan.</p>
        </li>
        <li> 
          <i>5. Teknologi Informasi dan Komunikasi</i>
          <p>Teknologi informasi dan komunikasi menuju modernisasi sebagai terminal kendaraan, bagaimana IPC Car Terminal bisa menerapkan Automated Car Terminal secara penuh.</p>
        </li>
      </ol>
      <br/>
      ...
      <p style="text-indent: 5em;" class="text-justify">Di mata Chiefy, mengelola IPC Car Terminal bukan semata-mata demi mencari nafkah. Akan tetapi, perusahaan dijadikannya sebagai tempat berkontribusi dan memberikan warna manfaat sebanyak-banyaknya. Tempatnya mengabdi dan membesarkan
        ...
        Indonesia.
        “Kita bekerja untuk kemajuan dan martabat negara melalui peran terbaik kita masingmasing. Karena itu, harus dilakukan dengan serius, baik, luar biasa, dan sepenuh hati,”
        ujarnya.
        “Kita harus mampu berkompetisi dengan perusahaan swasta yang dikelola secara
        efektif, transparan, dan profesional. Bahkan, harus memenangkan kompetisi tersebut melalui pengelolaan dengan cara semangat dan manajemen perusahaan swasta.
        Dengan begitu, kita bisa mensejajarkan diri dengan perusahaan swasta, baik dalam
      ...
      <p style="font-size: 22px; font-family: helvetica;"><i>Pendekatan Humanis</i></p>
      ...
      <p style="text-indent: 5em;" class="text-justify">
        Rasanya, mustahil mewujudkan mimpi membangun perusahaan besar, tetapi mengabaikan partisipasi dan peran serta seluruh karyawan di setiap tingkatan. “Karyawan
        ibarat akar sebuah pohon. Akar merupakan cerminan dari sebuah niat, karakter, dan
       ...
       <div class="col-sm-5">
          <img src="{{ url('img/pdf/6.jpg') }}" class="img-responsive">
        </div>      
      ...
      <p style="text-indent: 5em;" class="text-justify">IPC Car Terminal memang sedang giat berbenah. Wajah kantor IPC Indonesia CarTerminal saat ini pun terlihat lebih cerah. Ruang-ruang kerjanya terlihat semarak dan bergairah. Warna <i> corporate identity </i> -orange dan biru- dituangkannya ke dalam wallpaper
        ...
        karya nyata, bukan dari sebuah ucapan. Kewibawaan diuji dari satunya kata dengan perbuatan.
        “Tiada hari tanpa berkarya, memberikan manfaat bagi sesama, perusahaan, bangsa dan
