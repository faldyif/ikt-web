...
@section('title','Good Corporate Governance | IPC')
    ...
    <section id="heroTitle">
        <div class="heroTitle" style="background-image: url('{{ url('img/2.jpg') }}');">
            ...
            <section class="container-fluid pd-30">
                <h2 class="roboBold wh alignCenter" data-wow-delay="0.4s">Good Corporate Governance (GCG)</h2>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active">
                            <a data-toggle="pill" href="#home">
                                <div class="be-flex">
                                    <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>Good Corporate Governance (GCG)</span>
                                </div>
                            </a>
                        </li>
                    <li class="">
                      <a data-toggle="pill" href="#menu0">
                        <div class="be-flex">
                          <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>Komitmen Terhadap Penerapan Tata Kelola Perusahaan yang Baik Secara Berkelanjutan</span>
                        </div>
                      </a>
                    </li>
                    <li class="">
                      <a data-toggle="pill" href="#menu1">
                        <div class="be-flex">
                          <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>Pemegang Saham & RUPS</span>
                        </div>
                       </a>
                     </li>
                    <li class="">
                      <a data-toggle="pill" href="#menu2">
                        <div class="be-flex">
                         <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>BOD</span>
                        </div>
                       </a>
                     </li>
                      <li class="">
                ...
                <div class="col-md-9">
                  <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                      ...
                      <h4 class="card-title roboBold">Good Corporate Governance</h4>            
                      <p class="text-justify">Salah satu upaya untuk meningkatkan kinerja suatu perusahaan/organisasi adalah dengan cara menerapkan tata kelola perusahaan yang baik yang disebut <i>Good Corporate Governance</i> (GCG). Penerapan tata kelola perusahaan yang baik (GCG) merupakan pedoman bagi seluruh insan Perusahaan dalam membuat keputusan dan menjalankan tindakan dengan dilandasi moral yang tinggi, kepatuhan kepada peraturan perundang-undangan yang berlaku serta kesadaran akan adanya tanggung jawab sosial Perusahaan terhadap pihak-pihak yang berkepentingan <i>(stakeholders)</i> secara konsisten.</p>
                      <p class="text-justify">Adanya pelaksanaan GCG yang konsisten memungkinkan pertumbuhan dan <i>track record</i> yang <i>sustainable</i> untuk jangka panjang. Sebuah perusahaan yang telah melaksanakan GCG akan memiliki pandangan jangka panjang dalam mengintegrasikan tanggung jawab lingkungan dan sosial dengan pengelolaan risiko, menemukan peluang-peluang dan mengalokasikan modal untuk memberikan manfaat yang terbaik bagi seluruh pemangku kepentingan.</p>
                      <p class="text-justify">GCG akan mengarahkan praktik bisnis yang bertanggung jawab, sehingga memastikan pengelolaan lingkungan kerja yang positif dan kondusif, pertanggungjawaban kepada pasar dan komunitas serta pencapaian kinerja keuangan yang sehat dan berkesinambungan.</p>
                      <p class="text-justify">Dalam implementasinya, PT Indonesia Kendaraan Terminal menerapkan prinsip-prinsip GCG yang meliputi :</p>
                      <div class="bullet">
                        <ol>
                          <li>Keterbukaan <i>(transparency)</i>
                            <p class="text-justify">Perusahaan menjamin adanya keterbukaan dan objektivitas dalam melaksanakan proses pengambilan keputusan untuk menjalankan kegiatan usahanya. Perusahaan harus menyediakan informasi yang bersifat materil dan relevan mengenai perusahaan dengan cara yang mudah diakses dan dipahami oleh para pemangku kepentingan. Perusahaan harus mengambil inisiatif untuk mengungkapkan tidak hanya informasi yang dipersyaratkan oleh anggaran dasar dan peraturan perundang-undangan yang berlaku, tetapi juga hal-hal yang penting dan mempengaruhi pengambilan keputusan para pemangku kepentingan.</p>
                          </li>
                          <li>Akuntabilitas <i>(accountability)</i>
                            <p class="text-justify">Perusahaan bekerja dengan akuntabilitas tinggi serta mempertanggungjawabkan segala tindakannya secara transparan dan wajar untuk kepentingan Perusahaan sesuai dengan ketentuan anggaran dasar, peraturan perundang-undangan yang berlaku, etika perilaku bisnis, dan budaya perusahaan dengan tetap memperhatikan stakeholders guna mencapai kinerja Perusahaan secara berkesinambungan.</p>
                          </li>
                          <li>Tanggung Jawab <i>(responsibility)</i>
                            <p class="text-justify">Perusahaan berpegang teguh pada prinsip kehati-hatian dan memastikan kepatuhan terhadap peraturan perusahaan, Anggaran Dasar dan peraturan perundang-undangan yang berlaku, serta melaksanakan tanggung jawab sosial antara lain kepedulian terhadap masyarakat dan kelestarian lingkungan terutama di sekitar Perusahaan dengan membuat perencanaan dan pelaksanaan yang memadai sehingga terpelihara kesinambungan usaha Perusahaan.</p>
                          </li>
                          <li>Ketidak-berpihakan <i>(independent)</i>
                            <p class="text-justify">Perusahaan dikelola secara professional dengan menghindari benturan kepentingan serta pengaruh/tekanan dari pihak manapun yang tidak sesuai dengan peraturan perundang-undangan yang berlaku dari prinsip-prinsip korporasi yang sehat.</p>
                          </li>
                          <li>Kewajaran dan kesetaraan <i>(fairness)</i>
                            <p class="text-justify">Dalam melaksanakan kegiatannya Perusahaan senantiasa memperhatikan kepentingan berdasarkan asas kewajaran dan kesetaraan.</p>
                          </li>
                          <li>Terpercaya <i>(Trusted)</i>
                            <p class="text-justify">Mendapatkan kepercayaan dan dukungan penuh dari seluruh pemangku kepentingan.</p>
                          </li>
                        </ol>
                      </div>  
                    </div>
                    <div id="menu0" class="tab-pane fade">
                        <hr class="hrSpec hrSpecOrange">
                        <h4 class="card-title roboBold">Komitmen Terhadap Penerapan Tata Kelola Perusahaan yang Baik Secara Berkelanjutan</h4>
                        <p>Konten sedang disiapkan...</p>
                    </div>
                    <div id="menu1" class="tab-pane fade">
                        <hr class="hrSpec hrSpecOrange">
                        <h4 class="card-title roboBold">Pemegang Saham & RUPS</h4>
                        <p>Konten sedang disiapkan...</p>
                    </div>
                    <div id="menu2" class="tab-pane fade">
                        <hr class="hrSpec hrSpecOrange">
                        <h4 class="card-title roboBold">BOD Saat Ini</h4>
                        <div class="col-md-12">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 portfolio-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Direktur Komersial dan Pengembangan Bisnis<br>
                                            (September 2017 s.d saat ini)
                                        </p>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 portfolio-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Direktur Operasi dan Sistem Informasi<br>
                        ...
                        <hr class="hrSpec hrSpecOrange">
                        <h4 class="card-title roboBold">BOD 2012 s.d Maret 2017</h4>
