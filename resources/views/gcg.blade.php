                  ...
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active">
                      <a data-toggle="pill" href="#menu0">
                        <div class="be-flex">
                          <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>Tata Kelola Perusahaan Berkelanjutan</span>
                        </div>
                      </a>
                    </li>
                    <li class="">
                ...
                <div class="col-md-9">
                  <div class="tab-content">
                    <div id="menu0" class="tab-pane fade in active">
                      <h3 class="roboBlack">Latar Belakang</h3>
                      ...
                      <p>Sebagai perusahaan yang profesional, independen, berintegritas dan berkelanjutan isu anti Korupsi Kolusi dan Nepotisme (KKN) menjadi prioritas bagi manajemen Perusahaan. Dalam semangat tersebut, Manajemen Perseroan terus melakukan upaya-upaya untuk membersihkan diri dari praktekKKN, termasuk didalamnya upaya pengendalian praktekGratifikasi.</p>
                      <p>Perusahaan menyadari bahwa dalam menjalin hubungan kerja dengan pihak ketiga, baik stakeholder maupun vendor, seringkali bersinggungan dengan praktekgratifikasi, sehingga dibutuhkan sebuah pedoman untuk mengendalikan praktek tersebut. Hal ini dilakukan agar seluruh InsanPT INDONESIA KENDARAAN TERMINAL  memiliki pemahaman yang sama tentang perlakuan terhadap gratifikasi serta membantu InsanPT INDONESIA KENDARAAN TERMINAL  untuk tidak terjerat dalam praktek gratifikasi yang termasuk tindak pidana suap, sebagaimana diatur pada pasal 12 B Ayat (1) Undang-Undang Nomor 20 Tahun 2001 Tentang Perubahan Atas Undang-Undang Nomor 31 Tahun 1999 Tentang Pemberantasan Tindak Pidana Korupsi.</p>

                      <p>Pedoman Pengelolaan Gratifikasi ini diharapkan akan memperkokoh penegakan GCG Perusahaan dan menjadi acuan bagi seluruh InsanPT INDONESIA KENDARAAN TERMINAL  dalam menyikapi gratifikasi ketika berhubungan dengan pihak ketiga Perusahaan. Pedoman ini merupakan salah satu rangkaian dokumen penegakan GCG Perusahaan dimana konten dalam pedoman ini selaras dengan Pedoman GCG, Kode Etik Bisnis dan juga Tatalaksana Kinerja Direksi dan Dewan Komisaris PT Indonesia Kendaraan Terminal.</p>
