            ...
            <div id="menu3" class="tab-pane fade">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      <div class="col-md-3">
                        <!-- foto -->
                        
                        <img src="{{ url('img/Dede R. Martin - Komisaris Utama.jpg') }}" class="img-responsive foto">
                      </div>
                      <div class="col-md-9">
                        <!-- konten -->
                        <div class="col-md-8">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      <div class="col-md-3">
                        ...
                        <img src="{{ url('img/Abdul Hakam - Komisaris.jpg') }}" class="img-responsive foto">
                      </div>
                      <div class="col-md-9">
                        <!-- konten -->
                        <div class="col-md-8">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      <div class="col-md-3">
                        ...
                        <img src="{{ url('img/dasi.png') }}" class="img-responsive foto">
                      </div>
                      <div class="col-md-9">
                        <!-- konten -->
                        <div class="col-md-8">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      <div class="col-md-3">
                        <!-- foto -->
                        <img src="{{ url('img/Dian Lesmana - Komisaris.jpg') }}" class="foto img-responsive">
                      </div>
                      <div class="col-md-9">
                        <!-- konten -->
                        <div class="col-md-8">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="col-md-9">
                          <div class="card-title">
                            <a href="#"> Marta Hadisarwono</a>
                          </div>
                          <p>Komisaris Bidang Keuangan</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      <div class="col-md-3">
                        ...
                        <img src="{{ url('img/Dian Lesmana - Komisaris.jpg') }}" class="img-responsive foto">
                      </div>
                      <div class="col-md-9">
                        <!-- konten -->
                        <div class="col-md-8">
                  ...
                  <div class="col-md-12 mg-bt-5 flex-row-center">
                    <div class="card1">
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="col-md-8">
                          <div class="card-title">
                            <a href="#"> Fathoni Akbar</a>
                          </div>
                          <p>Komisaris Bidang Manajemen Resiko</p>
                        </div>
                      </div>
                    </div>
                  </div>
