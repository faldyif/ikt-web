...
@section('title','Penilaian | IPC Car Terminal')
    ...
    <section id="heroTitle">
        <div class="heroTitle" style="background-image: url('{{ url('img/2.jpg') }}');">
            ...
            <section class="container-fluid pd-30">
                <h2 class="roboBold wh alignCenter" data-wow-delay="0.4s">Penilaian</h2>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active">
                            <a data-toggle="pill" href="#home">
                                <div class="be-flex">
                                    <i class="fa fa-th mg-r-15 mg-t-5"></i> <span>Hasil Survei Kepuasan Pelanggan</span>
                                </div>
                            </a>
                        </li>
                    {{--<li class="">--}}
                ...
                <div class="col-md-9">
                  <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                      ...
                      <h4 class="card-title roboBold">Hasil Survei Kepuasan Pelanggan</h4>
                        <img class="img-responsive" src="{{ url('img/hskp2017.jpg') }}" alt="">
                        <img class="img-responsive" src="{{ url('img/hskp2016.jpg') }}" alt="">
                    </div>
