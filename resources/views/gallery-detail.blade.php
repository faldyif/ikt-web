    ...
    <section id="gallery-list">
        <div class="container-fluid wow fadeInUpBig pd-30">
            ...
            <div class="grid">
                ...
                <div class="grid-item">
                    <figure>
                        <a href="{{ url('img/port01.jpg') }}" data-rel="lightcase:galleryCollection"
                           title="Vix eu etiam mediocrem">
                    ...
                    <section class="mg-bt-30">
                        ...
                        <section class="row pd-t-10">
                            <figure class="col-md-1 col-md-1 col-sm-1 bg-img mg-t-10">
                                <img src="{{ url('img/bg-square.png') }}" alt="user"
                                     style="background-image: url('{{ url('img/port02.jpg') }}');" class="rounded">
                            </figure>
                            <div class="col-md-9 col-sm-10 col-sm-10">
                                <h5 class="big roboBold">Someone</h5>
                                <p class="text-muted">15 Agustus 2017</p>
                                <p>Aliquam principes deterruisset cum et, vel an eius equidem. Id quando legimus inermis
                                    eum, cibo consul democritum cum te, cu cum suas laudem graeci. Bonorum gloriatur
                                    signiferumque an pro.</p>
                            </div>
