...
@section('title','Olahraga, Seni & Budaya | IPC Car Terminal')
    ...
    <section id="heroTitle">
      <div class="heroTitle" style="background-image: url('{{ url('img/2.jpg') }}');">
        ...
        <section class="container-fluid pd-30">
          <h2 class="roboBold wh alignCenter" data-wow-delay="0.4s">Olahraga, Seni & Budaya</h2>
      ...
      <div class="container-fluid wow fadeInUpBig">
        <section class="row pd-t-20">
          <div class="col-md-8 col-sm-10 col-sm-offset-1 pd-bt-30">
            ...
            <h3 class="mg-b-30 roboBold">Olahraga, Seni & Budaya</h3>
              <h2>Coming Soon...</h2>
            </div>
          </div>
        </section>
