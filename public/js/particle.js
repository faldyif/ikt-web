...
window.onload = function() {
    ...
    var logoLocation = {
        ...
        y: center.y - logoDimensions.y / 10
    };
    ...
    function render() {
        ...
        for(var i = 0; i < particleArr.length; i++) {
            var p = particleArr[i];
            // var pixelData = canvas.getContext('2d').getImageData(p.x, p.y, 1, 1).data;
            // var hex = rgb2hex('rgba(' + pixelData[0] + ',' + pixelData[1] + ',' + pixelData[2] + ',' + pixelData[3] + ')');
            // console.log(particleAttributes.color);
